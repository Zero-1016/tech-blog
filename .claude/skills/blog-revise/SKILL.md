...
```
AskUserQuestion("어느 수정안으로 진행할까요?"):
- 수정안 1
- 수정안 2
- 둘 다 마음에 안 들어요 — 다시 제안
- 취소
...
```
AskUserQuestion("이 자료를 어느 섹션에 통합할까요?"):
- 섹션 1: 왜 비율 유지가 어려운가
...
```
AskUserQuestion("재작성 시 무엇을 유지할까요?"):
- 제목과 slug 유지, 본문만 새로
- 전부 새로 (제목도 다시)
- 취소
```
...
```
AskUserQuestion("진단 결과를 보고 다음 행동을 선택해주세요"):
